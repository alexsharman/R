#StopWATCH ####
#A Stopwatch R6class object you can use in your R scprits for timing and benchmarking of your code
                     ...
                     public = list(
                       ...
                       endLap = function(lap_name = NULL) {
                         if (isTRUE(self$hasEnded)) {
                           ...
                           cat(lap_name, " ran in: ", paste0(private$timeAsFormattedString(private$lastFinishedLapTime())))
                         }
                       }
...
# 
ST$endLap()
ST$endLap(lap_name = "Your process")
ST$endLap()
# #Finish total 
ST$end()
